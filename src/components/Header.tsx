        ...
        <div className="w-full max-w-6xl mx-auto px-4 h-[90px] flex items-center justify-between">
          ...
          {activeAnns.length > 0 && (
            <div
              ...
              className="hidden md:flex items-center gap-4 bg-gray-50 border border-gray-200 pl-2 pr-4 py-2 rounded-full cursor-pointer group hover:border-brand-red/30 hover:shadow-md transition-all w-[640px] mx-auto animate-in fade-in slide-in-from-top-1 duration-500 overflow-hidden relative"
            >
