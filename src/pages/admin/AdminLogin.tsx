...
export default function AdminLogin() {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            alert('Google girişi başlatılamadı: ' + (error.message || 'Bilinmeyen hata'));
        }
    };
        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
                ...
                <button
                    ...
                    className="w-full bg-white border border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 group"
                >
                    ...
                    <span className="group-hover:text-gray-900 transition-colors">Google ile Giriş Yap</span>
                </button>
